...
function runTimestampValidation(fields, maxAgeHours) {
    ...
    if (!extractedTimestamp) {
        logger_1.logger.debug('No timestamp extracted — flagging for review');
        return {
            serverTimestamp,
            isFuture: false,
            isTooOld: false,
    ...
    logger_1.logger.debug({ extractedTimestamp, ageHours, isFuture, isTooOld, passed }, 'Timestamp validation complete');
    return {
        extractedTimestamp,
        serverTimestamp,
...
//# sourceMappingURL=TimestampValidation.js.map